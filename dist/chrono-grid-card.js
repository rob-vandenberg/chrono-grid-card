import{LitElement,html,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";import{styleMap}from"https://unpkg.com/lit@2.0.0/directives/style-map.js?module";import{unsafeHTML}from"https://unpkg.com/lit@2.0.0/directives/unsafe-html.js?module";const CARD_VERSION="0.0.10",mdiDragHorizontalVariant="M9,3H11V5H9V3M13,3H15V5H13V3M9,7H11V9H9V7M13,7H15V9H13V7M9,11H11V13H9V11M13,11H15V13H13V11M9,15H11V17H9V15M13,15H15V17H13V15M9,19H11V21H9V19M13,19H15V21H13V19Z";console.info("%c CHRONO-%cGRID%c-CARD %c v0.0.10 ","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 0 2px 4px; border-radius: 3px 0 0 3px;","background-color: #101010; color: #4676d3; font-weight: bold; padding: 2px 0;","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 4px 2px 0;","background-color: #1E1E1E; color: #FFFFFF; font-weight: bold; padding: 2px 4px; border-radius: 0 3px 3px 0;");const DEFAULT_CELL={width:"1fr",background_color:"",border_width:0,border_style:"solid",border_color:"",border_radius:0,padding_top:0,padding_bottom:0,padding_left:0,padding_right:0,card:{}},DEFAULT_ROW={gap:8,background_color:"",border_width:0,border_style:"solid",border_color:"",border_radius:0,padding_top:0,padding_bottom:0,padding_left:0,padding_right:0,cells:[]},DEFAULT_CONFIG={background_color:"",border_width:1,border_style:"solid",border_color:"",border_radius:12,padding_top:8,padding_bottom:8,padding_left:8,padding_right:8,box_shadow:"",rows:[]},NUMERIC_CONFIG_KEYS=new Set(["border_width","border_radius","padding_top","padding_bottom","padding_left","padding_right"]),NUMERIC_ROW_KEYS=new Set(["gap","border_width","border_radius","padding_top","padding_bottom","padding_left","padding_right"]),NUMERIC_CELL_KEYS=new Set(["border_width","border_radius","padding_top","padding_bottom","padding_left","padding_right"]);function cgParseNumber(e){const o=String(e).replace(",",".");if("-"===o||"-0"===o||o.endsWith("."))return null;if(o.includes(".")&&o.endsWith("0"))return null;if(""===o)return;const t=parseFloat(o);return isNaN(t)?null:t}function cgTextField(e,o,t,r={}){return html`
  ...
  `;constructor(){super(),this.value="",this.options=[],this._open=!1,this._cursor=-1,this._onOutsideClick=this._onOutsideClick.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onOutsideClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onOutsideClick)}_onOutsideClick(e){this.shadowRoot.contains(e.composedPath()[0])||e.composedPath()[0]===this||(this._open=!1,this._cursor=-1)}_select(e){this.value=e,this._open=!1,this._cursor=-1,this.dispatchEvent(new CustomEvent("change",{detail:{value:e},bubbles:!0,composed:!0}))}_handleKeyDown(e){const o=this.options??[];this._open?"ArrowDown"===e.key?(this._cursor=Math.min(this._cursor+1,o.length-1),e.preventDefault()):"ArrowUp"===e.key?(this._cursor=Math.max(this._cursor-1,0),e.preventDefault()):"Enter"===e.key?(this._cursor>=0&&this._cursor<o.length&&this._select(o[this._cursor].value),e.preventDefault()):"Escape"===e.key&&(this._open=!1,this._cursor=-1,e.preventDefault()):"ArrowDown"!==e.key&&"ArrowUp"!==e.key||(this._open=!0,this._cursor=0,e.preventDefault())}render(){const e=this.options??[];return html`
      ...
      `:""}
    `}}customElements.define("chrono-cg-select",CgSelect);class ChronoGridCardEditor extends LitElement{static properties={hass:{attribute:!1},lovelace:{attribute:!1},_config:{state:!0}};setConfig(e){this._config={...DEFAULT_CONFIG,...e}}_dispatchConfig(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_valueChanged(e,o){if(!this._config)return;const t=o.target.value??o.detail?.value;let r;if(NUMERIC_CONFIG_KEYS.has(e)){const o=cgParseNumber(t);if(null===o)return;r=void 0===o?DEFAULT_CONFIG[e]:o}else r=t;this._config={...this._config,[e]:r},this._dispatchConfig()}_rowChanged(e,o,t){if(!this._config)return;const r=t.target.value??t.detail?.value;let i;if(NUMERIC_ROW_KEYS.has(o)){const e=cgParseNumber(r);if(null===e)return;i=void 0===e?DEFAULT_ROW[o]:e}else i=r;const n=this._config.rows.map((t,r)=>r===e?{...t,[o]:i}:t);this._config={...this._config,rows:n},this._dispatchConfig()}_cellChanged(e,o,t,r){if(!this._config)return;const i=r.target.value??r.detail?.value;let n;if(NUMERIC_CELL_KEYS.has(t)){const e=cgParseNumber(i);if(null===e)return;n=void 0===e?DEFAULT_CELL[t]:e}else n=i;const d=this._config.rows.map((r,i)=>{if(i!==e)return r;const d=r.cells.map((e,r)=>r===o?{...e,[t]:n}:e);return{...r,cells:d}});this._config={...this._config,rows:d},this._dispatchConfig()}_cardEditorElements=new Map;_findDialogTarget(){let e=this;for(;e;){if("provideHass"in e)return e;const o=e.getRootNode();e=o instanceof ShadowRoot?o.host:null}return null}_pickCard(e,o){if(!this._config)return;const t=this._findDialogTarget(),r={dialogTag:"hui-dialog-create-card",dialogImport:()=>customElements.whenDefined("hui-dialog-create-card").then(()=>{}).catch(()=>{}),dialogParams:{lovelaceConfig:this.lovelace??{config:{views:[]}},saveConfig:()=>{},path:[0],saveCard:t=>{const r=this._config.rows.map((r,i)=>{if(i!==e)return r;const n=r.cells.map((e,r)=>r===o?{...e,card:t}:e);return{...r,cells:n}});this._config={...this._config,rows:r},this._cardEditorElements.delete(`${e}-${o}`),this._dispatchConfig()}}};t?t.dispatchEvent(new CustomEvent("show-dialog",{bubbles:!0,composed:!0,detail:r})):this.dispatchEvent(new CustomEvent("show-dialog",{bubbles:!0,composed:!0,detail:r}))}_cardConfigChanged(e,o,t){if(t.stopPropagation(),!this._config)return;const r=t.detail.config,i=this._config.rows.map((t,i)=>{if(i!==e)return t;const n=t.cells.map((e,t)=>t===o?{...e,card:r}:e);return{...t,cells:n}});this._config={...this._config,rows:i},this._dispatchConfig()}_clearCard(e,o){if(!this._config)return;this._cardEditorElements.delete(`${e}-${o}`);const t=this._config.rows.map((t,r)=>{if(r!==e)return t;const i=t.cells.map((e,t)=>t===o?{...e,card:{}}:e);return{...t,cells:i}});this._config={...this._config,rows:t},this._dispatchConfig()}updated(){(this._config?.rows??[]).forEach((e,o)=>{(e.cells??[]).forEach((e,t)=>{if(!e.card||0===Object.keys(e.card).length)return;const r=`${o}-${t}`,i=this.shadowRoot.querySelector(`.card-editor-mount[data-row="${o}"][data-cell="${t}"]`);if(!i)return;let n=this._cardEditorElements.get(r);n||(n=document.createElement("hui-card-element-editor"),n.addEventListener("config-changed",e=>this._cardConfigChanged(o,t,e)),this._cardEditorElements.set(r,n)),n.hass=this.hass,n.lovelace=this.lovelace,n.value=e.card,i.contains(n)||(i.innerHTML="",i.appendChild(n))})})}_addRow(){const e=[...this._config.rows??[],{...DEFAULT_ROW,cells:[{...DEFAULT_CELL}]}];this._config={...this._config,rows:e},this._dispatchConfig()}_removeRow(e){const o=this._config.rows.filter((o,t)=>t!==e);this._config={...this._config,rows:o},this._dispatchConfig()}_duplicateRow(e){const o=JSON.parse(JSON.stringify(this._config.rows[e])),t=[...this._config.rows];t.splice(e+1,0,o),this._config={...this._config,rows:t},this._dispatchConfig()}_rowMoved(e){e.stopPropagation();const{oldIndex:o,newIndex:t}=e.detail,r=[...this._config.rows];r.splice(t,0,r.splice(o,1)[0]),this._config={...this._config,rows:r},this._dispatchConfig()}_addCell(e){const o=this._config.rows.map((o,t)=>t!==e?o:{...o,cells:[...o.cells,{...DEFAULT_CELL}]});this._config={...this._config,rows:o},this._dispatchConfig()}_removeCell(e,o){const t=this._config.rows.map((t,r)=>r!==e?t:{...t,cells:t.cells.filter((e,t)=>t!==o)});this._config={...this._config,rows:t},this._dispatchConfig()}_cellMoved(e,o){o.stopPropagation();const{oldIndex:t,newIndex:r}=o.detail,i=this._config.rows.map((o,i)=>{if(i!==e)return o;const n=[...o.cells];return n.splice(r,0,n.splice(t,1)[0]),{...o,cells:n}});this._config={...this._config,rows:i},this._dispatchConfig()}_borderStyleOptions=[{label:"Solid",value:"solid"},{label:"Dashed",value:"dashed"},{label:"Dotted",value:"dotted"},{label:"Double",value:"double"},{label:"None",value:"none"}];static styles=css`
  ...
  `;render(){if(!this._config)return html``;const e=this._config,o=e.rows??[],t=e=>void 0!==e&&""!==e?`${e}px`:void 0,r=e=>void 0!==e&&""!==e?e:void 0,i=(e,o,t,r)=>void 0!==e&&""!==e&&void 0!==o&&""!==o&&void 0!==t&&""!==t&&void 0!==r&&""!==r?`${e}px ${o}px ${t}px ${r}px`:void 0,n={"background-color":r(e.background_color),"border-width":t(e.border_width),"border-style":r(e.border_style),"border-color":r(e.border_color),"border-radius":t(e.border_radius),padding:i(e.padding_top,e.padding_right,e.padding_bottom,e.padding_left),"box-shadow":r(e.box_shadow)};return html`
      <div class="grid-wrapper" style=${styleMap(n)}>
        ${o.map((e,o)=>{const n={"grid-template-columns":(e.cells??[]).map(e=>e.width||"1fr").join(" ")||"1fr",gap:t(e.gap),"background-color":r(e.background_color),"border-width":t(e.border_width),"border-style":r(e.border_style),"border-color":r(e.border_color),"border-radius":t(e.border_radius),padding:i(e.padding_top,e.padding_right,e.padding_bottom,e.padding_left)};return html`
            <div class="grid-row" style=${styleMap(n)}>
              ${(e.cells??[]).map((e,n)=>{const d={"background-color":r(e.background_color),"border-width":t(e.border_width),"border-style":r(e.border_style),"border-color":r(e.border_color),"border-radius":t(e.border_radius),padding:i(e.padding_top,e.padding_right,e.padding_bottom,e.padding_left)};return html`
                  <div
                    class="grid-cell"
                    data-row=${o}
                    data-cell=${n}
